...
class InterpretationApi
{
     ...
     *
     * @param  \Jawwws\Gnaww\Model\ContinuePrintRequirementRequest $continue_print_requirement_request continue_print_requirement_request (required)
     ...
     * @return \Jawwws\Gnaww\Model\ContinuePrintRequirementResponse|\Jawwws\Gnaww\Model\ContinuePrintRequirementInterpretationDefaultResponse
     */
    public function continuePrintRequirementInterpretation($continue_print_requirement_request, $x_gnaww_workspace_id = null, string $contentType = self::contentTypes['continuePrintRequirementInterpretation'][0])
    {
        list($response) = $this->continuePrintRequirementInterpretationWithHttpInfo($continue_print_requirement_request, $x_gnaww_workspace_id, $contentType);
        return $response;
    }
     ...
     * Continue Print Requirement Interpretation
     *
     * @param  \Jawwws\Gnaww\Model\ContinuePrintRequirementRequest $continue_print_requirement_request (required)
     * @param  string|null $x_gnaww_workspace_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['continuePrintRequirementInterpretation'] to see the possible values for this operation
     *
     * @throws \Jawwws\Gnaww\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Jawwws\Gnaww\Model\ContinuePrintRequirementResponse|\Jawwws\Gnaww\Model\ContinuePrintRequirementInterpretationDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function continuePrintRequirementInterpretationWithHttpInfo($continue_print_requirement_request, $x_gnaww_workspace_id = null, string $contentType = self::contentTypes['continuePrintRequirementInterpretation'][0])
    {
        $request = $this->continuePrintRequirementInterpretationRequest($continue_print_requirement_request, $x_gnaww_workspace_id, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Jawwws\Gnaww\Model\ContinuePrintRequirementResponse',
                        $request,
                        $response,
                    );
                default:
     ...
     */
    public function continuePrintRequirementInterpretationAsync($continue_print_requirement_request, $x_gnaww_workspace_id = null, string $contentType = self::contentTypes['continuePrintRequirementInterpretation'][0])
    {
        return $this->continuePrintRequirementInterpretationAsyncWithHttpInfo($continue_print_requirement_request, $x_gnaww_workspace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function continuePrintRequirementInterpretationAsyncWithHttpInfo($continue_print_requirement_request, $x_gnaww_workspace_id = null, string $contentType = self::contentTypes['continuePrintRequirementInterpretation'][0])
    {
        $returnType = '\Jawwws\Gnaww\Model\ContinuePrintRequirementResponse';
        $request = $this->continuePrintRequirementInterpretationRequest($continue_print_requirement_request, $x_gnaww_workspace_id, $contentType);
     ...
     */
    public function continuePrintRequirementInterpretationRequest($continue_print_requirement_request, $x_gnaww_workspace_id = null, string $contentType = self::contentTypes['continuePrintRequirementInterpretation'][0])
    {

        // verify the required parameter 'continue_print_requirement_request' is set
        if ($continue_print_requirement_request === null || (is_array($continue_print_requirement_request) && count($continue_print_requirement_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $continue_print_requirement_request when calling continuePrintRequirementInterpretation'
            );
        }
        ...
        // for model (json/xml)
        if (isset($continue_print_requirement_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($continue_print_requirement_request));
            } else {
                $httpBody = $continue_print_requirement_request;
            }
     ...
     * @throws \Jawwws\Gnaww\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Jawwws\Gnaww\Model\InterpretPrintRequirementResponse|\Jawwws\Gnaww\Model\InterpretPrintRequirementDefaultResponse
     */
     ...
     * @throws \Jawwws\Gnaww\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Jawwws\Gnaww\Model\InterpretPrintRequirementResponse|\Jawwws\Gnaww\Model\InterpretPrintRequirementDefaultResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function interpretPrintRequirementWithHttpInfo($interpret_print_requirement_request, $x_gnaww_workspace_id = null, string $contentType = self::contentTypes['interpretPrintRequirement'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Jawwws\Gnaww\Model\InterpretPrintRequirementResponse',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\Jawwws\Gnaww\Model\InterpretPrintRequirementResponse';
        $request = $this->interpretPrintRequirementRequest($interpret_print_requirement_request, $x_gnaww_workspace_id, $contentType);
