...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.gnaww.io';

    /**
     * User agent of the HTTP request, set to "gnaww-sdk/{version}/PHP" by default
     *
     * @var string
     */
    protected $userAgent = 'gnaww-sdk/0.1.0/PHP';
    ...
    {
        $report  = 'PHP SDK (Jawwws\Gnaww) Debug Report:' . PHP_EOL;
