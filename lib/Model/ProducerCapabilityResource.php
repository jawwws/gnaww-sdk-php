...
/**
 * ProducerCapabilityResource Class Doc Comment
 *
 * @category Class
 * @description Safe capability-only projection of one producer profile.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class ProducerCapabilityResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProducerCapabilityResource';
    ...
    protected static $openAPITypes = [
        ...
        'products' => '\Jawwws\Gnaww\Model\ProducerProductCapability[]',
        'schema_name' => 'string',
    ...
    public const SCHEMA_NAME_GNAWW_PRODUCER_CAPABILITY_RESOURCE = 'gnaww.producer_capability_resource';
    ...
    {
        return [
            self::SCHEMA_NAME_GNAWW_PRODUCER_CAPABILITY_RESOURCE,
        ];
    }
    ...
    public function setProducerId($producer_id)
    {
        ...
        if ((mb_strlen($producer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $producer_id when calling ProducerCapabilityResource., must be bigger than or equal to 1.');
        }
    ...
    public function setProducerName($producer_name)
    {
        ...
        if ((mb_strlen($producer_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $producer_name when calling ProducerCapabilityResource., must be bigger than or equal to 1.');
        }
    ...
    public function setProducerProfileId($producer_profile_id)
    {
        ...
        if ((mb_strlen($producer_profile_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $producer_profile_id when calling ProducerCapabilityResource., must be bigger than or equal to 1.');
        }
    ...
    public function setProducerProfileSchemaVersion($producer_profile_schema_version)
    {
        ...
        if ((mb_strlen($producer_profile_schema_version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $producer_profile_schema_version when calling ProducerCapabilityResource., must be bigger than or equal to 1.');
        }
     ...
     * Gets products
     *
     * @return \Jawwws\Gnaww\Model\ProducerProductCapability[]
     */
     ...
     * Sets products
     *
     * @param \Jawwws\Gnaww\Model\ProducerProductCapability[] $products products
     *
     * @return self
     */
    public function setProducts($products)
    {
        ...
        if ((count($products) < 1)) {
            throw new \InvalidArgumentException('invalid length for $products when calling ProducerCapabilityResource., number of items must be greater than or equal to 1.');
        }
