...
/**
 * AvailabilityCapability Class Doc Comment
 *
 * @category Class
 * @description Stable availability mode and optional live current status.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class AvailabilityCapability implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AvailabilityCapability';
    ...
    public const MODE_MADE_TO_ORDER = 'made_to_order';
    public const MODE_STOCKED = 'stocked';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mode', $data ?? [], 'unknown');
    ...
    public function setAvailableQuantity($available_quantity)
    {
        if (is_null($available_quantity)) {
            array_push($this->openAPINullablesSetToNull, 'available_quantity');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('available_quantity', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($available_quantity) && ($available_quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $available_quantity when calling AvailabilityCapability., must be bigger than or equal to 0.');
        }
