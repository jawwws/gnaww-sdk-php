...
/**
 * RepeatedDrillPattern Class Doc Comment
 *
 * @category Class
 * @description Rectangular repeated drill pattern with one controlled hole geometry.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class RepeatedDrillPattern implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RepeatedDrillPattern';
    ...
    protected static $openAPITypes = [
        ...
        'height_mm' => 'float',
        'origin' => '\Jawwws\Gnaww\Model\Point2D',
    ...
    protected static $setters = [
        'column_spacing_mm' => 'setColumnSpacingMm',
        'columns' => 'setColumns',
        'depth_mm' => 'setDepthMm',
        ...
        'origin' => 'setOrigin',
        'row_spacing_mm' => 'setRowSpacingMm',
        'rows' => 'setRows',
        'shape' => 'setShape',
        'style' => 'setStyle',
        'width_mm' => 'setWidthMm'
    ...
    protected static $getters = [
        'column_spacing_mm' => 'getColumnSpacingMm',
        'columns' => 'getColumns',
        'depth_mm' => 'getDepthMm',
        ...
        'origin' => 'getOrigin',
        'row_spacing_mm' => 'getRowSpacingMm',
        'rows' => 'getRows',
        'shape' => 'getShape',
        'style' => 'getStyle',
        'width_mm' => 'getWidthMm'
    ...
    {
        $this->setIfExists('column_spacing_mm', $data ?? [], 0);
        $this->setIfExists('columns', $data ?? [], 1);
        ...
        $this->setIfExists('row_spacing_mm', $data ?? [], 0);
        $this->setIfExists('rows', $data ?? [], 1);
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['column_spacing_mm']) && ($this->container['column_spacing_mm'] < 0.0)) {
            $invalidProperties[] = "invalid value for 'column_spacing_mm', must be bigger than or equal to 0.0.";
        }

        if (!is_null($this->container['columns']) && ($this->container['columns'] <= 0)) {
            $invalidProperties[] = "invalid value for 'columns', must be bigger than 0.";
        }
        ...
        if (!is_null($this->container['row_spacing_mm']) && ($this->container['row_spacing_mm'] < 0.0)) {
            $invalidProperties[] = "invalid value for 'row_spacing_mm', must be bigger than or equal to 0.0.";
        }

        if (!is_null($this->container['rows']) && ($this->container['rows'] <= 0)) {
            $invalidProperties[] = "invalid value for 'rows', must be bigger than 0.";
        }
    ...
    /**
     * Gets column_spacing_mm
     *
     * @return float|null
     */
    public function getColumnSpacingMm()
    {
        return $this->container['column_spacing_mm'];
    }

    /**
     * Sets column_spacing_mm
     *
     * @param float|null $column_spacing_mm column_spacing_mm
     *
     * @return self
     */
    public function setColumnSpacingMm($column_spacing_mm)
    {
        if (is_null($column_spacing_mm)) {
            throw new \InvalidArgumentException('non-nullable column_spacing_mm cannot be null');
        }

        if (($column_spacing_mm < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $column_spacing_mm when calling RepeatedDrillPattern., must be bigger than or equal to 0.0.');
        }

        $this->container['column_spacing_mm'] = $column_spacing_mm;
     ...
     * Sets columns
     *
     * @param int|null $columns columns
     *
     * @return self
     */
    public function setColumns($columns)
    {
        ...
        if (($columns <= 0)) {
            throw new \InvalidArgumentException('invalid value for $columns when calling RepeatedDrillPattern., must be bigger than 0.');
        }
    ...
    public function setDepthMm($depth_mm)
    {
        ...
        if (!is_null($depth_mm) && ($depth_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $depth_mm when calling RepeatedDrillPattern., must be bigger than 0.0.');
        }
    ...
    public function setDiameterMm($diameter_mm)
    {
        ...
        if (!is_null($diameter_mm) && ($diameter_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $diameter_mm when calling RepeatedDrillPattern., must be bigger than 0.0.');
        }
    ...
    public function setHeightMm($height_mm)
    {
        ...
        if (!is_null($height_mm) && ($height_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $height_mm when calling RepeatedDrillPattern., must be bigger than 0.0.');
        }
     ...
     * Sets origin
     *
     * @param \Jawwws\Gnaww\Model\Point2D $origin origin
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getRowSpacingMm()
    {
        return $this->container['row_spacing_mm'];
    }

    /**
     * Sets row_spacing_mm
     *
     * @param float|null $row_spacing_mm row_spacing_mm
     *
     * @return self
     */
    public function setRowSpacingMm($row_spacing_mm)
    {
        if (is_null($row_spacing_mm)) {
            throw new \InvalidArgumentException('non-nullable row_spacing_mm cannot be null');
        }

        if (($row_spacing_mm < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $row_spacing_mm when calling RepeatedDrillPattern., must be bigger than or equal to 0.0.');
        }

        $this->container['row_spacing_mm'] = $row_spacing_mm;
    ...
    public function setRows($rows)
    {
        ...
        if (($rows <= 0)) {
            throw new \InvalidArgumentException('invalid value for $rows when calling RepeatedDrillPattern., must be bigger than 0.');
        }
    ...
    public function setWidthMm($width_mm)
    {
        ...
        if (!is_null($width_mm) && ($width_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $width_mm when calling RepeatedDrillPattern., must be bigger than 0.0.');
        }
