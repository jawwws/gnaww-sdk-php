...
/**
 * PrintOperationParameters Class Doc Comment
 *
 * @category Class
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class PrintOperationParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrintOperationParameters';
    ...
    public const KIND__PRINT = 'print';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('kind', $data ?? [], 'print');
    ...
    public function setColourantSystem($colourant_system)
    {
        if (is_null($colourant_system)) {
            array_push($this->openAPINullablesSetToNull, 'colourant_system');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('colourant_system', $nullablesSetToNull);
            if ($index !== FALSE) {
