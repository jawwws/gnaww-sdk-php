...
/**
 * MatchPrintDemandResponse Class Doc Comment
 *
 * @category Class
 * @description Public deterministic capability-fit result for validated demand.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class MatchPrintDemandResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MatchPrintDemandResponse';
    ...
    public const SCHEMA_NAME_GNAWW_SPECMATCH_RESULT = 'gnaww.specmatch_result';
    ...
    {
        return [
            self::SCHEMA_NAME_GNAWW_SPECMATCH_RESULT,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('schema_name', $data ?? [], 'gnaww.specmatch_result');
