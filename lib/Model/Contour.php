...
class Contour implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setHeightMm($height_mm)
    {
        ...
        if (($height_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $height_mm when calling Contour., must be bigger than 0.0.');
        }
    ...
    public function setWidthMm($width_mm)
    {
        ...
        if (($width_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $width_mm when calling Contour., must be bigger than 0.0.');
        }
    ...
    public function setXMm($x_mm)
    {
        ...
        if (($x_mm < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $x_mm when calling Contour., must be bigger than or equal to 0.0.');
        }
    ...
    public function setYMm($y_mm)
    {
        ...
        if (($y_mm < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $y_mm when calling Contour., must be bigger than or equal to 0.0.');
        }
    ...
    public function setDiameterMm($diameter_mm)
    {
        ...
        if (($diameter_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $diameter_mm when calling Contour., must be bigger than 0.0.');
        }
    ...
    public function setAssetRef($asset_ref)
    {
        ...
        if ((mb_strlen($asset_ref) < 1)) {
            throw new \InvalidArgumentException('invalid length for $asset_ref when calling Contour., must be bigger than or equal to 1.');
        }
