...
/**
 * PrintJobSpecification Class Doc Comment
 *
 * @category Class
 * @description Canonical Jawwws print job specification returned by Gnaww.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class PrintJobSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrintJobSpecification';
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling PrintJobSpecification., must be smaller than or equal to 1.0.');
        }
        if (($confidence < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling PrintJobSpecification., must be bigger than or equal to 0.0.');
        }
