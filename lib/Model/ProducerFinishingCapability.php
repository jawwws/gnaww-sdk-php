...
/**
 * ProducerFinishingCapability Class Doc Comment
 *
 * @category Class
 * @description A finishing operation a producer can manufacture.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class ProducerFinishingCapability implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProducerFinishingCapability';
