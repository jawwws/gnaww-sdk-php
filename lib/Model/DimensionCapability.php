...
/**
 * DimensionCapability Class Doc Comment
 *
 * @category Class
 * @description An exact standard or named physical dimension capability.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class DimensionCapability implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DimensionCapability';
    ...
    public function setDepthMm($depth_mm)
    {
        ...
        if (!is_null($depth_mm) && ($depth_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $depth_mm when calling DimensionCapability., must be bigger than 0.0.');
        }
    ...
    public function setDiameterMm($diameter_mm)
    {
        ...
        if (!is_null($diameter_mm) && ($diameter_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $diameter_mm when calling DimensionCapability., must be bigger than 0.0.');
        }
    ...
    public function setHeightMm($height_mm)
    {
        ...
        if (!is_null($height_mm) && ($height_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $height_mm when calling DimensionCapability., must be bigger than 0.0.');
        }
    ...
    public function setWidthMm($width_mm)
    {
        ...
        if (!is_null($width_mm) && ($width_mm <= 0.0)) {
            throw new \InvalidArgumentException('invalid value for $width_mm when calling DimensionCapability., must be bigger than 0.0.');
        }
