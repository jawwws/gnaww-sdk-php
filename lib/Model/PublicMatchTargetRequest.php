...
/**
 * PublicMatchTargetRequest Class Doc Comment
 *
 * @category Class
 * @description Explicit capability target for one public SpecMatch operation.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class PublicMatchTargetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PublicMatchTargetRequest';
    ...
    public function setProducerProfileId($producer_profile_id)
    {
        ...
        if ((mb_strlen($producer_profile_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $producer_profile_id when calling PublicMatchTargetRequest., must be bigger than or equal to 1.');
        }
