 ...
 *
 * @category Class
 * @description Requested production quantity.
 * @package  Jawwws\Gnaww
...
class Quantity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('variable_data', $data ?? [], false);
    }
    ...
    public function setUnits($units)
    {
        ...
        if (!is_null($units) && ($units <= 0)) {
            throw new \InvalidArgumentException('invalid value for $units when calling Quantity., must be bigger than 0.');
        }
     ...
     * Sets variable_data
     *
     * @param bool|null $variable_data variable_data
     *
     * @return self
     */
    public function setVariableData($variable_data)
    {
        if (is_null($variable_data)) {
            throw new \InvalidArgumentException('non-nullable variable_data cannot be null');
        }
