...
/**
 * ResolveRecipeResponse Class Doc Comment
 *
 * @category Class
 * @description Outcome of idempotently resolving a canonical GJS to a Recipe.
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class ResolveRecipeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ResolveRecipeResponse';
    ...
    protected static $openAPITypes = [
        'recipe' => '\Jawwws\Gnaww\Model\RecipeResource',
        'schema_name' => 'string',
    ...
    public const SCHEMA_NAME_GNAWW_RECIPE_RESOLVE_RESULT = 'gnaww.recipe_resolve_result';
    ...
    {
        return [
            self::SCHEMA_NAME_GNAWW_RECIPE_RESOLVE_RESULT,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('schema_name', $data ?? [], 'gnaww.recipe_resolve_result');
     ...
     * Gets recipe
     *
     * @return \Jawwws\Gnaww\Model\RecipeResource
     */
     ...
     * Sets recipe
     *
     * @param \Jawwws\Gnaww\Model\RecipeResource $recipe recipe
     *
     * @return self
     */
