...
/**
 * DecorationOperationParameters Class Doc Comment
 *
 * @category Class
 * @package  Jawwws\Gnaww
 * @implements \ArrayAccess<string, mixed>
 */
class DecorationOperationParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DecorationOperationParameters';
    ...
    public const KIND_DECORATION = 'decoration';
    ...
    {
        $this->setIfExists('kind', $data ?? [], 'decoration');
    ...
    public function setMethod($method)
    {
        ...
        if ((mb_strlen($method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $method when calling DecorationOperationParameters., must be bigger than or equal to 1.');
        }
    ...
    public function setThreadOrColourant($thread_or_colourant)
    {
        if (is_null($thread_or_colourant)) {
            array_push($this->openAPINullablesSetToNull, 'thread_or_colourant');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('thread_or_colourant', $nullablesSetToNull);
            if ($index !== FALSE) {
